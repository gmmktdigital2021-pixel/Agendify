          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand/10 text-brand text-sm font-bold mb-6">
                Software para Manicures e Nail Designers
              </div>
              <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight text-slate-900 leading-tight mb-6">
                Brilhe na sua arte, <br className="hidden lg:block"/><span className="text-brand">nós na agenda.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-xl">
                Pare de atender chamadas para marcar horário. Suas clientes agendam extensões, hidratações e manutenções online 24/7.
              </p>
      ...
      <section id="funcionalidadesNicho" className="py-24 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-4 tracking-tight">Ferramentas para Manicures e Nail Designers</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-brand/10 hover:shadow-xl transition-all duration-300 group">
              <h3 className="font-bold text-lg text-slate-800 mb-2 group-hover:text-brand transition-colors">Gestão de serviços</h3>
              <p className="text-slate-500 text-sm">verniz 30min vs gel 2h</p>
            </div>
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-brand/10 hover:shadow-xl transition-all duration-300 group">
              <h3 className="font-bold text-lg text-slate-800 mb-2 group-hover:text-brand transition-colors">Anti-faltas</h3>
              <p className="text-slate-500 text-sm">cobrança de sinal automática</p>
            </div>
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-brand/10 hover:shadow-xl transition-all duration-300 group">
              <h3 className="font-bold text-lg text-slate-800 mb-2 group-hover:text-brand transition-colors">Portfólio de nail art</h3>
              <p className="text-slate-500 text-sm">suas criações em destaque</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="inline-flex items-center gap-4 text-left">
            ...
            <div>
              <h4 className="font-bold text-white text-lg">Sofia</h4>
              <p className="text-slate-400 font-medium">Nail Designer</p>
            </div>
          </div>
        </div>
      </section>
