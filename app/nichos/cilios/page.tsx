          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand/10 text-brand text-sm font-bold mb-6">
                Software para Lash Designers
              </div>
              <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight text-slate-900 leading-tight mb-6">
                Olhares impecáveis, <br className="hidden lg:block"/><span className="text-brand">agenda organizada.</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-xl">
                Do volume russo à extensão fio a fio — agende todos os seus serviços online e elimine o caos das mensagens.
              </p>
      ...
      <section id="funcionalidadesNicho" className="py-24 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-4 tracking-tight">Ferramentas para Lash Designers</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-brand/10 hover:shadow-xl transition-all duration-300 group">
              <h3 className="font-bold text-lg text-slate-800 mb-2 group-hover:text-brand transition-colors">Controle de manutenções</h3>
              <p className="text-slate-500 text-sm">avisa quando vence a manutenção</p>
            </div>
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-brand/10 hover:shadow-xl transition-all duration-300 group">
              <h3 className="font-bold text-lg text-slate-800 mb-2 group-hover:text-brand transition-colors">Tempo por serviço</h3>
              <p className="text-slate-500 text-sm">volume russo 3h vs manutenção 1h</p>
            </div>
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-brand/10 hover:shadow-xl transition-all duration-300 group">
              <h3 className="font-bold text-lg text-slate-800 mb-2 group-hover:text-brand transition-colors">Lista de espera automática</h3>
              <p className="text-slate-500 text-sm">preencha desmarcações em segundos</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-300 text-2xl md:text-3xl font-medium mb-12 italic leading-relaxed">
            "Minhas clientes adoram receber o lembrete de manutenção automático. Agenda sempre cheia."
          </p>
          <div className="inline-flex items-center gap-4 text-left">
            ...
            <div>
              <h4 className="font-bold text-white text-lg">Bianca</h4>
              <p className="text-slate-400 font-medium">Lash Designer</p>
            </div>
          </div>
        </div>
      </section>
